    ...
    return {
      ...
      rules: {
        ...
        simpleRequiredText: [
          ...
          { min: 1, max: 100, message: '长度在1~20个字符', trigger: ['blur', 'change'] }
        ],
        ...
        idNumber: [
          { required: true, message: '输入不能为空', trigger: ['blur', 'change'] },
          { validator: validIdNum, trigger: ['blur', 'change'] }
        ],
        mobileNum: [
          { required: true, message: '输入不能为空', trigger: ['blur', 'change'] },
          { validator: validMobilePhone, trigger: ['blur', 'change'] }
        ],
        email: [
        ...
        zipCode: [
          { validator: validZipcode, trigger: ['blur', 'change'] }
        ]
      }
    }
  },
