<template>
  <div class="cloudcontent" id="cloud_agencyContract">
    <div class="main">
      ...
      <submitApproveDialog :flowStatus="flowStatus" :showVisible="approveDialogVisable" ref="approvalDialog" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
