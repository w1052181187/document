<template>
  <div class="cloudcontent" id="cloud_registProjectAdd">
    <div class="main">
      ...
      <submitApproveDialog :flowStatus="flowStatus" :showVisible="approveDialogVisable" :tenderSystemCode="addForm.code" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
    </div>
  </div>
</template>
<script>
