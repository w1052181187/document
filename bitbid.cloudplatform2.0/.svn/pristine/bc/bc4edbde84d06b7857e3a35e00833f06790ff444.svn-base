<template>
  <div class="cloudcontent" id="biddetail">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="评标办法：">
              <el-input type="textarea" v-model="updateForm.bidEvaluationMethod" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="供应商资格条件：">
              <el-input type="textarea" v-model="updateForm.supplierCondition" readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
