<template>
  <div class="cloudcontent" id="cloud_processedit">
    <div class="main">
      ...
      <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="sectionSystemCode"></section-bidder-dialog>
