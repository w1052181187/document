<template>
  <div class="cloudcontent">
    ...
    <div class="main viewdetails">
      <div class="basic-approve-title">资格预审澄清文件</div>
      <el-form :model="updateForm" label-width="200px" :validate-on-rule-change="true">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="提交资格申请文件截止时间：">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="供应商资格条件：">
              <span>{{updateForm.supplierCondition}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    ...
    getBidSection () {
      bidSection.getOne(this.$route.query.sectionSystemCode).then(res => {
        ...
        this.nodeContent = this.bidSection.tenderProjectName + this.bidSection.bidSectionName + '资格预审澄清文件'
      })
    },
    init () {
