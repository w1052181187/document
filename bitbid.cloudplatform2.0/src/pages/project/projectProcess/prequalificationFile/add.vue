  ...
  <div class="cloudcontent">
    <div class="main">
      <el-form :model="updateForm" label-width="200px" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="申请有效期(天)：" prop="termOfValidity">
  ...
  methods: {
    ...
    getBidSection () {
      bidSection.getOne(this.$route.query.sectionSystemCode).then(res => {
        ...
        this.updateForm.prequalificationTime = this.bidSection.prequalificationTime
        this.updateForm.prequalificationAddress = this.bidSection.prequalificationAddress
      })
    }
  },
  mounted () {
