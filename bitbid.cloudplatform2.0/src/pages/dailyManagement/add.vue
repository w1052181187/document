      ...
      <el-form :model="updateForm" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
        ...
        <el-form-item label="接收者：" prop="receiver">
          <el-popover
            ...
            <treeCheckbox :isShow="true" :initData='receiveDepartmentIds' @changeChecked="handleChangeChecked"></treeCheckbox>
      ...
      if (this.$route.params.objectId) {
        notice.detailNotice(this.$route.params.objectId, 0).then((res) => {
          if (res.data.resCode === '0000') {
            ...
            if (this.updateForm.departmentIds) {
              this.receiveDepartmentIds = this.updateForm.departmentIds.split(',')
            }
