<template>
  <div class="cloudcontent">
    ...
    <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="updateForm"></section-bidder-dialog>
