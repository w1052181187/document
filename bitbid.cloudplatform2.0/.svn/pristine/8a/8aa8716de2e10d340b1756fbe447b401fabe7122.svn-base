      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" v-if="(scope.row.auditStatus === 2 || scope.row.auditStatus === 4) && scope.row.type !== 3 && changeBullinFlag" @click="addNoticeBtn(scope)">添加更正公告</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
