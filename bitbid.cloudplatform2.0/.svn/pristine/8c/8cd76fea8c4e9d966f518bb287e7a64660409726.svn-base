      ...
      <el-form :model="enterpriseForm" :rules="rules" ref="enterpriseForm" :validate-on-rule-change="true">
        ...
        <div class="part">
          ...
          <div class="formmain">
            <el-row>
              <el-col :span="12">
                <el-form-item label="营业执照：" prop="fileValue1" :rules="rules.fileValue" class="bitianicon">
              ...
              <el-col :span="12">
                <el-form-item label="开户许可：" prop="fileValue4" :rules="rules.fileValue" class="bitianicon">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="法人身份证（正）：" prop="fileValue6" :rules="rules.fileValue" class="bitianicon">
              ...
              <el-col :span="12">
                <el-form-item label="法人身份证（反）：" prop="fileValue7" :rules="rules.fileValue" class="bitianicon">
        ...
        <el-form-item class="submit-radio">
          <el-button type="primary" v-if="this.enterpriseForm.status === 3" @click="saveEnterprise('enterpriseForm')" :loading="loadingFlag">修改</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
