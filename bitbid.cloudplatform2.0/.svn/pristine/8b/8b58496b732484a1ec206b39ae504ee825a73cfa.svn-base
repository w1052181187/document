<template>
  <div class="cloudcontent">
    ...
    <select-user-dialog :isComponyId="1" :showVisible="showAdminVisible" @selected="selectedAdmin" @showDialog="closAdminDialog"></select-user-dialog>
    <!-- 新增档案室-->
    <!-- 新增档案柜-->
