<template>
  <div class="cloudcontent" id="cloud_processedit">
    ...
    <div class="main viewdetails">
      <div class="basic-approve-title">开标记录表疑义及澄清</div>
    ...
    getQuesAndAnsInfo () {
      questionAndAnswerInfo.getById(this.objectId).then(res => {
        ...
        if (this.updateForm.bidSection) {
          ...
          this.nodeContent = this.bidSection.tenderProjectName + this.bidSection.bidSectionName + '开标记录表疑义及澄清'
        }
