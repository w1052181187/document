<template>
  <div class="cloudcontent">
    ...
    <div class="main viewdetails">
      <div class="basic-approve-title">投标受理信息</div>
      <el-form :model="updateForm" :validate-on-rule-change="true">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="受理情况：">
              <span>{{updateForm.auditStatus | formatStatus}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="驳回时间：">
              <span>{{updateForm.rejectionTime | formatDate}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="驳回理由：">
              <span>{{updateForm.rejectionReason}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  filters: {
    ...
    formatStatus (value) {
      if (Object.is(Number(value), 7)) {
        return '未受理'
      } else if (Object.is(Number(value), 8)) {
        return '已受理'
      } else if (Object.is(Number(value), 9)) {
        return '已驳回'
      }
    }
  },
