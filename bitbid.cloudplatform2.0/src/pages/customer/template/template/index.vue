<template>
  <div class="cloudcontent">
    <div class="main">
      ...
      <el-table :data="tableData" border  header-cell-class-name="tableheader" v-loading="loading">
        <el-table-column
          type="index"
          label="序号"
          width="80"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="handleUpdate(scope)" v-if="$store.getters.permissions.includes('1040302')">修改</el-button>
            <el-button type="text" size="small" @click="logoff(scope.row.objectId)" v-if="$store.getters.permissions.includes('1040302')">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
