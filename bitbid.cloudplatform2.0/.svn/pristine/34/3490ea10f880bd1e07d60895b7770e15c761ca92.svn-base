<template>
  <div class="cloudcontent">
    <div class="main">
      <el-form :model="updateForm" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="投标人提交时间："  prop="signUpTime">
              <el-date-picker
    ...
    <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="$route.query.sectionSystemCode"></section-bidder-dialog>
    <submitApproveDialog :showVisible="approveDialogVisable" :tenderSystemCode="tenderSystemCode" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
  </div>
</template>
<script>
import {signUpInfo, bidSection} from '@/api/project'
