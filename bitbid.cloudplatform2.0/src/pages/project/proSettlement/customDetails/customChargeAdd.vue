      ...
      <div class="dialogUnaudited-content">
        <div>
          <el-input v-model="companyChooseName">
            <el-button type="primary" slot="append" size="mini" @click="companyChooseSrh">查询</el-button>
          </el-input>
      ...
      <div class="dialogUnaudited-content">
        <div>
          <el-input v-model="paymentTendersName" placeholder="请输入标段名称">
            <el-button type="primary" slot="append" size="mini" @click="paymentTenderSrh">查询</el-button>
          </el-input>
        </div>
...
export default {
  ...
  methods: {
    ...
    tableRowClick (row, event, column) {
      ...
      this.ruleForm.bidderId = row.bidderId
