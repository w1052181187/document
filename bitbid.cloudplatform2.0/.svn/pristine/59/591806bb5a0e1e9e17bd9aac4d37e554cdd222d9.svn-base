<template>
  <div class="cloudcontent">
    ...
    <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :includeNames="includeBidderNames"
...
import {documentInfo, bidSection, resultInfo} from '@/api/project'
