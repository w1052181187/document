<template>
  <div class="cloudcontent" id="cloud_processedit">
    ...
    <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :flowStatus="flowStatus" :includeNames="includeBidderNames" :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="sectionSystemCode"></section-bidder-dialog>
...
import {resultInfo, bidSection, winBiddingConfirmationLetter} from '@/api/project'
