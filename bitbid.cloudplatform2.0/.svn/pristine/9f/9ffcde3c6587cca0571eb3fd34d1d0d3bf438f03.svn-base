        ...
        <el-row>
          <el-col :span="24" class="ueditor_box">
            <el-form-item label="疑义内容：" class="bitianicon">
              <editor v-if="Number(updateForm.dataSource) === 0" ref="objectionUeditor" class="ueditor" :editread="false"></editor>
              <editor v-if="Number(updateForm.dataSource) === 1" ref="objectionUeditor" class="ueditor" :editread="true"></editor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
