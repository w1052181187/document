      ...
      <el-col :span="leftnum" class="leftcontent">
        <div class="message">
          <div class="fl">
            ...
            <ul class="meslist">
              <li>
                <router-link to="/bidOpening?openingTimeType=1">
              ...
              <li>
                <router-link to="/bidOpening?openingTimeType=2">
              ...
              <li>
                <router-link to="/bidOpening?openingTimeType=3">
              ...
              <li>
                <router-link to="/bidOpening?openingTimeType=4">
...
export default {
  ...
  methods: {
    ...
    handleIconBtn (day, month, year) {
      ...
      this.$router.push({path: '/bidOpening?openingTimeType=5&selectDate=' + currentDate})
    },
    getCalendarData () {
      let query = {
