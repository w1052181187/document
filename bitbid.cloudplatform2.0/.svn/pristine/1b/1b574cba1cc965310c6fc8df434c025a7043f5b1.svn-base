  ...
  <div class="cloudcontent" id="cloud_processtype">
    <div class="box" v-show="signUpVisable">
      <div class="topmain">
        投标受理信息
        <!--按钮-->
        <el-button  type="primary" class="addbutton" @click="handleAdd" v-if="!tradingPlatformFlag">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" v-if="(scope.row.auditStatus === 0 || scope.row.auditStatus === 3 || scope.row.auditStatus === 5)" @click="handleEdit(scope)">编辑</el-button>
            <el-button type="text" size="small" v-if="scope.row.auditStatus === 0" @click="handleDel(scope, 'bond')">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
