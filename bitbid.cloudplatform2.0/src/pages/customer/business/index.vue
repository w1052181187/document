      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="followBtn(scope)" v-if="scope.row.status < 3 && $store.getters.permissions.includes('1040202')">跟进</el-button>
