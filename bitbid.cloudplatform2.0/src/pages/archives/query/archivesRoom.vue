  ...
  <div>
    ...
    <ul>
      ...
      <template v-if="curType === 'list'">
                ...
                <el-row>
                  <el-col style="width: 340px;">
                    <el-form-item label="移交人：">
                      ...
                      <select-user-dialog :isComponyId="1" :showVisible="showTransferVisible" @selected="selectedTransfer" @showDialog="showTransferDialog"></select-user-dialog>
                    </el-form-item>
                  </el-col>
                  <el-col style="width: 340px;">
        ...
        <table-list ref="table" :searchForm = 'searchForm' :archivesCabinetId="archivesCabinetId" :archivesRoomId="archivesRoomId" :query = 'query'></table-list>
      </template>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // 移交人
    showTransferDialog () {
      this.showTransferVisible = !this.showTransferVisible
    },
    // 选择移交人
