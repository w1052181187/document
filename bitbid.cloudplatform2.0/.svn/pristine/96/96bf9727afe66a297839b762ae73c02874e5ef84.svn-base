    ...
    <div class="main">
      ...
      <el-table
        ...
        <el-table-column
          ...
          fixed="right">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="updateOrder(scope)" v-if="scope.row.status !== 0 && $store.getters.permissions.includes('1020102')">修改</el-button>
            <el-button type="text" size="small" @click="delOrder(scope)" v-if="scope.row.status !== 1 && $store.getters.permissions.includes('1020102')">删除</el-button>
            <el-button type="text" size="small" @click="cancelOrder(scope)" v-if="scope.row.status !== 0 && $store.getters.permissions.includes('1020102')">取消预约</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
