...
export default {
  ...
  methods: {
    ...
    addBtn () {
      if (this.pageText === '其他支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/otherPayAdd`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode, settlementGroupName: this.settlementGroupName}})
      } else if (this.pageText === '支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/payAdd`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode, settlementGroupName: this.settlementGroupName}})
      }
    },
    lookBtn (rowData) {
      if (this.pageText === '其他支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/otherPayDetail/${rowData.objectId}`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode}})
      } else if (this.pageText === '支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/payDetail/${rowData.objectId}`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode}})
      }
    },
    goBack () {
    ...
    update (rowData) {
      if (this.pageText === '其他支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/otherPayAdd/${rowData.objectId}`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode}})
      } else if (this.pageText === '支出') {
        this.$router.push({path: `/project/proSettlement/otherIncomePay/payAdd/${rowData.objectId}`, query: {text: this.pageText, tenderSystemCode: this.tenderSystemCode, settlementGroupCode: this.settlementGroupCode}})
      }
    },
    delBtn (rowData) {
