<template>
  <div class="cloudcontent">
    ...
    <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="tenderSystemCode" :includeNames="includeBidderNames" :flowStatus="flowStatus" :flag="flag"
                           :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="updateForm.sectionSystemCode"></section-bidder-dialog>
    <submitApproveDialog :tenderSystemCode="tenderSystemCode" :flowStatus="flowStatus" ref="approvalDialog" :showVisible="approveDialogVisable" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
  </div>
</template>
<script>
