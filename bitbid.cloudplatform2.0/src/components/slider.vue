  ...
  <div class="menu" id="menu">
    ...
    <div class="menu_box">
      ...
      >
        ...
        <el-submenu v-if="adminEnterpriseIds.includes($store.getters.authUser.enterpriseId)">
          <template>
            <template slot="title">
              <span :class="otherModule.picname">{{otherModule.title}}</span>
            </template>
            <el-menu-item-group >
              <el-menu-item v-for="child in otherModule.children" :key="child.id" :index='child.index' v-if="!child.moduleId || $store.getters.modules.includes(child.moduleId)">
                {{child.childtitle}}
              </el-menu-item>
            </el-menu-item-group>
          </template>
