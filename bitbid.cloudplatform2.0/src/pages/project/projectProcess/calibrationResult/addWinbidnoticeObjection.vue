<template>
  <div class="cloudcontent" id="cloud_processedit">
    <div class="main">
      ...
      <section-bidder-dialog v-if="tradingPlatformFlag" :tenderSystemCode="updateForm.tenderSystemCode" :showVisible="showBidderVisible" @selected="selectedBidder" @showDialog="showBidderDialog" :sectionSystemCode="sectionSystemCode"></section-bidder-dialog>
...
import {questionAndAnswerInfo, bidSection} from '@/api/project/index'
