<template>
  <div class="announcement-list cloudcontent" id="tenderFeeList">
    <div class="topmain" style="height:41px;">
      <el-row>
        <div class="seacher_box">
          <span>公告名称/招标人：</span>
          <el-input class="keyword-input" v-model="search_input" placeholder="请输入公告或招标人关键字"></el-input>
          <el-button type="primary" @click="tenderFeeSrh">查询</el-button>
    ...
    <div class="main">
      <div class="fr">
        <el-button type="primary" class="addbutton import-button" @click="exportWordBtn">
          <span>导出word</span>
        </el-button>
        <el-button type="primary" class="addbutton" @click="toCalendarBtn">
          <span>返回日历</span>
        </el-button>
      </div>
      <el-table
