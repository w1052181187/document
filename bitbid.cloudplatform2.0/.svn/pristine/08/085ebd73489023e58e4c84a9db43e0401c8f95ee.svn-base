<template>
  <div class="cloudcontent" id="cloud_agencyContract">
    <div class="main">
      ...
      <submitApproveDialog :flowStatus="flowStatus" :agencyContractCode="updateForm.code" :showVisible="approveDialogVisable" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
