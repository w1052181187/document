<template>
  <div id="file-upload">
    <div class="file-type-name">
      <span v-if="fileName !== 'no'">{{fileName}}附件</span>
    </div>
    <el-table
    ...
    <!--添加弹框-->
    <el-dialog :before-close="handleCancle" :title="dialogTitle ? dialogTitle : ('上传' + fileName + '附件')" :visible.sync="dialogVisible" width="50%">
