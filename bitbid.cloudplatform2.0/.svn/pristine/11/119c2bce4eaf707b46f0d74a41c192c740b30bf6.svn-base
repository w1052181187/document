...
var calendar = {
  ...
  solar2lunar: function (y, m, d) { // 参数区间1900.1.31~2100.12.31
    ...
    let temp = 0
    // 修正ymd参数
    // let yc = objDate.getFullYear()
    // let mc = objDate.getMonth() + 1
    // let dc = objDate.getDate()
   ...
   */
  lunar2solar: function (y, m, d, isLeapMonthc) { // 参数区间1900.1.31~2100.12.1
    let isLeapMonth = !!isLeapMonthc
