<template>
  <div class="cloudcontent" id="cloud_processedit">
    ...
    <div class="main viewdetails">
      <div class="basic-approve-title">开标记录</div>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="开标参与者：">
              <span class="participant-title">采购人:</span>
              <el-table
              ...
              <span class="participant-title">投标人代表:</span>
              <el-table
              ...
              <span class="participant-title">代理机构:</span>
              <el-table
    ...
    getDocumentInfo () {
      documentInfo.getById(this.objectId).then(res => {
        ...
        if (this.updateForm.bidSection) {
          ...
          this.nodeContent = this.bidSection.tenderProjectName + this.bidSection.bidSectionName + '开标记录'
        }
