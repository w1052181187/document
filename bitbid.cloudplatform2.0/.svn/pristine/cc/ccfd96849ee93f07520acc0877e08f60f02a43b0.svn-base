  ...
  <div>
    <div class="module">
        ...
        <div class="right">
          ...
          <el-button type="primary" class="return-btn" @click="handleAccept(0)"
                     v-if="archivesClassifyList.length > 0 && (Number(archivesClassifyList[activeMenuIndex].transferStatus) === 1 || Number(archivesClassifyList[activeMenuIndex].transferStatus) === 2)
                     && Number(archivesClassifyList[activeMenuIndex].status) !== 1">退回</el-button>
          <el-button type="primary" class="accept-btn" @click="handleAccept(1)"
                     v-if="archivesClassifyList.length > 0 && Number(archivesClassifyList[activeMenuIndex].transferStatus) === 2 && Number(archivesClassifyList[activeMenuIndex].status) !== 1">接收</el-button>
          <div class="line"></div>
          <div class="content">
