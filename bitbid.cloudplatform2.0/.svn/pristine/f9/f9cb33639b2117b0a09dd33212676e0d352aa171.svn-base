...
export default {
  ...
  methods: {
    ...
    calculatePrice () {
      if (this.serviceForm.serviceYear !== '6') {
      ...
      if (this.serviceForm.serviceContent && (this.serviceForm.serviceYear ||
        ...
        if (Object.is(this.serviceForm.serviceContent, '1')) {
          if (!Object.is(this.serviceForm.serviceYear, '6')) {
            this.serviceForm.orderPrice = Number(this.serviceForm.serviceYear * 19800).toFixed(2)
          } else {
            this.serviceForm.orderPrice = Number(this.serviceForm.otherTerm * 19800).toFixed(2)
          }
          ...
          if (this.checkboxList.length) {
            ...
            if (!Object.is(this.serviceForm.serviceYear, '6')) {
              this.serviceForm.orderPrice = Number(this.serviceForm.serviceYear * onYearPrice).toFixed(2)
            } else {
              this.serviceForm.orderPrice = Number(this.serviceForm.otherTerm * onYearPrice).toFixed(2)
            }
          }
        }
      }
