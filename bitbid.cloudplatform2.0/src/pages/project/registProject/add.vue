        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="项目编号：">
              <!--<span>（提交时自动生成）</span>-->
              <el-input v-model="addForm.projectCode" placeholder="可手动输入，如未输入则在提交后系统按规则自动生成编号"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        isPppProject: [
          { required: true, message: '请选择是否为PPP项目', trigger: ['blur', 'change'] }
        ],
