  ...
  <div class="cloudcontent">
    <div class="main">
      <el-form :model="updateForm" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
            ...
            <div class="process">
              <el-row class="top">
                ...
                <el-col :span="22" class="top_col">
                  <el-button class="selectbtn" @click="handleDelBtn(index)" v-if="index !== 0 && index === processList.length - 1">删除</el-button>
        ...
        <el-form-item v-if="processList.length < 3">
...
export default {
  ...
  methods: {
      ...
      switch (this.activeTab) {
        ...
        case '3':
          if (this.userNode.hasOwnProperty('account')) {
            this.processList[this.itemIndex].approvalFlowExecutor.usersNameStr = this.userNode.name
    ...
    submit () {
      ...
      // 等级赋值
      this.processList.map((item) => {
        item.approvalFlowExecutor.flowLevel = item.flowLevel
      })
      this.isSubmiting = true
      approvalFlow.approvalFlowListUpdate(this.processList).then((res) => {
