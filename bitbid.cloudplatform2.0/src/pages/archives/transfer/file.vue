<template>
  <div class="cloudcontent" id="bid-file">
    <div class="main">
      <div class="transfer-info viewdetails">
        <el-form :model="info">
          <el-row>
            <el-col :span="12">
              <el-form-item label="移交状态：">
                <span v-if="info.transferStatus === 0">待移交</span>
                <span v-if="info.transferStatus === 1">部分移交</span>
                <span v-if="info.transferStatus === 3">已退回</span>
                <span v-if="info.transferStatus === 2">全部移交</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="最新移交人：">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="移交进度：">
                <span>{{info.transferSchedule}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="最新移交时间：">
                <span>{{info.lastkTransferTime}}</span>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
