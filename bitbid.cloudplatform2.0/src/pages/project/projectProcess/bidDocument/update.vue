  ...
  <div class="cloudcontent">
    <div class="main">
      <el-form :model="updateForm" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
          ...
          <el-col :span="12">
            <el-form-item label="采购文件费用：" prop="fileCost">
              <el-select v-model="updateForm.fileCost" placeholder="请选择" clearable>
                <el-option label="有" :value="Number(1)"></el-option>
                <el-option label="无" :value="Number(0)"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="响应有效期(天)：" prop="termOfValidity">
          ...
          <el-col :span="12">
            <el-form-item label="响应文件递交方式：" prop="responseSubmissionMethod">
              <el-select v-model="updateForm.responseSubmissionMethod" placeholder="请选择" clearable>
                <el-option label="线上递交" :value="Number(1)"></el-option>
                <el-option label="线下递交" :value="Number(2)"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="控制价金额(元)：" prop="controlledPrice">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="是否缴纳保证金：" prop="bond">
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="Number(updateForm.bond) === 1">
            <el-form-item label="保证金金额(元)：" prop="bondPrice">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        bidEvaluationMethod: {required: true, message: '请填写评标办法', trigger: 'blur'},
        fileCost: {required: true, message: '请选择采购文件费用', trigger: 'change'},
        chargingMethod: {required: true, message: '请选择收费方式', trigger: 'change'},
        tenderPrice: [
          {required: true, message: '请填写标书售价', trigger: 'blur'},
