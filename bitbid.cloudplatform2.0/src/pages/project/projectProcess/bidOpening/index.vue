  ...
  <div class="cloudcontent" id="cloud_processtype">
    ...
    <div class="box">
      <div class="topmain">
        开标记录
        <!--按钮-->
        <el-button  type="primary" class="addbutton" @click="addBidrecordBtn()" v-if="operationFlag && this.bidRecordData.length === 0">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" v-if="(scope.row.auditStatus === 4 && scope.row.clarificationState === 0) && operationFlag"  @click="clarifyRecordclearBtn(scope)">澄清</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
    ...
    <div class="box">
      <div class="topmain">
        评标报告及中标候选人名单
        <!--按钮-->
        <el-button  type="primary" class="addbutton" @click="addBidreportBtn()" v-if="operationFlag && bidReportData.length === 0">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
