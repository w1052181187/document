      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" v-if="(scope.row.auditStatus === 2 || scope.row.auditStatus === 4) && operationFlag" @click="handleGdRelease(scope)">发布</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
