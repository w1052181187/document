<template>
  <div class="cloudcontent">
    ...
    <submitApproveDialog ref="approvalDialog" :tenderSystemCode="tenderSystemCode" :showVisible="approveDialogVisable" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
  </div>
</template>
<script>
