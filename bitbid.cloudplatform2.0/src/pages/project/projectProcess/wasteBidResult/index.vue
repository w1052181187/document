  ...
  <div class="cloudcontent" id="cloud_processtype">
    <div class="box">
      <div class="topmain">
        ...
        <div class="fr">
          <!--按钮-->
          <el-button type="primary" @click="lookBtn"><span>查看</span></el-button>
          ...
          <el-button @click="delBtn" v-if="updateForm.auditStatus === 0 || updateForm.auditStatus === 3 || updateForm.auditStatus === 5"><span>删除</span></el-button>
          <!--按钮-->
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    /** 查看操作 */
    lookBtn () {
      this.$router.push({path: `/project/projectProcess/project/process/wasteBidResult/detail/${this.updateForm.code}`, query: {sectionSystemCode: this.sectionSystemCode}})
    },
    /** 编辑操作 */
    editBtn () {
