  ...
  <div class="cloudcontent" id="cloud_processtype">
    <div class="box">
      <div class="topmain">
        投标邀请书
        <!--按钮-->
        <el-button  type="primary" class="addbutton" @click="handleAdd" v-if="operationFlag && tableData.length === 0">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" v-if="operationFlag && scope.$index === 0 && scope.row.auditStatus === 6 " @click="handleTender(scope)">投标人确认情况</el-button>
...
export default {
  ...
  mounted () {
    // console.log(this.checkDataSource)
    this.getTableData()
  }
}
</script>
