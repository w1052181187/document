<template>
  <div class="cloudcontent">
    <div class="main">
      ...
      <submitApproveDialog :tenderSystemCode="$route.query.tenderSystemCode" :showVisible="approveDialogVisable" ref="approvalDialog" @confirmSubmit="confirmSubmit" @handleCancel="cancelApprove"></submitApproveDialog>
    </div>
  </div>
</template>
