<template>
  <div class="cloudcontent" id="archives_transfer">
    <div class="main">
      ...
      <file v-if="active === 2" :info="info" ref="file"></file>
      <fileEnd v-if="active === 3" :info="info" ref="fileEnd" :archivesProject="archivesProject"></fileEnd>
...
<script>
import {archivesInfo, archivesProject} from '@/api/archives'
